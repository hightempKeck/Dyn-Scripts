...
cube = dyn.ops.load_part(path=r"C:/Users/Public/Documents/Dyndrite/Python/sample_data/step/10mm_cube.step",
     auto_center=True,
     transform=None,
     translate_only=None,
     open_geometry=False,
...
cylinder_left = dyn.ops.load_part(path=r"C:/Users/Public/Documents/Dyndrite/Python/sample_data/step/10mm_cube.step",
     auto_center=True,
     transform=None,
     translate_only=None,
     open_geometry=False,
...
cylinder_right = dyn.ops.load_part(path=r"C:/Users/Public/Documents/Dyndrite/Python/sample_data/step/10mm_cube.step",
     auto_center=True,
     transform=None,
     translate_only=None,
     open_geometry=False,
...
def on_slice(ctx: dyn.LayerContext, writer: dyn.VectorWriter, layer_idx):
